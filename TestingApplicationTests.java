...
class TestingApplicationTests {
	...
	@Test
	void repoTest() {
		BiFunction<RepoDummy, String, Optional<Object>> fun = RepoDummy::findById;
	...
	void testingValidator() throws ValidatorException {
		TestClass objectToValidate = new TestClass();
		List<Integer> set = List.of(1, 2, -10, 99, 11, 22, 0);
		objectToValidate.setId("notNullId12323");
		objectToValidate.setSomeString("ForbiddenValue");
		objectToValidate.setSomeNumbers(set);
